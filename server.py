...
Source: https://github.com/adityaarsharma/librecrawl-technical-seo-audit-mcp
"""
...
You are driving librecrawl-technical-seo-audit-mcp — a self-hosted SEO audit MCP server. Read
...
mcp = FastMCP("librecrawl-technical-seo-audit-mcp", instructions=LIBRECRAWL_MCP_INSTRUCTIONS)
...
def _build_report(pages: list, base_url: str, crawl_id: int,
    ...
    lines.append("")
    lines.append(f"---\n*Generated by [librecrawl-technical-seo-audit-mcp](https://github.com/adityaarsharma/librecrawl-technical-seo-audit-mcp)*")
...
def _fetch_sitemap_urls(sitemap_url: str, _depth: int = 0) -> tuple:
    ...
    try:
        r = httpx.get(sitemap_url, timeout=20, follow_redirects=True,
                      headers={"User-Agent": "librecrawl-technical-seo-audit-mcp/sitemap-recon"})
...
def librecrawl_audit_zip(session_id: str, auto_cleanup: bool = True) -> dict:
    ...
    with _zf.ZipFile(buf, "w", compression=_zf.ZIP_DEFLATED, compresslevel=6) as zf:
        ...
        summary_lines = [
            ...
            "By Aditya Sharma — github.com/adityaarsharma/librecrawl-technical-seo-audit-mcp",
            "",
            f"Site:        {url}",
