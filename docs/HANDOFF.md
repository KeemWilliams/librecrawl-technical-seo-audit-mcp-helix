# HANDOFF — librecrawl-technical-seo-audit-mcp v1.7 backlog

**Last shipped:** v1.6.0 (commit [`179ece0`](https://github.com/adityaarsharma/librecrawl-technical-seo-audit-mcp/commit/179ece0), tag [`v1.6.0`](https://github.com/adityaarsharma/librecrawl-technical-seo-audit-mcp/releases/tag/v1.6.0)) — 2026-06-03.
...
- **Source:** `/Users/adityasharma/Claude Projects/POSIMYTH/...` is the project workspace; the librecrawl-technical-seo-audit-mcp repo lives at `/tmp/librecrawl-technical-seo-audit-mcp-work/` (git clone of `adityaarsharma/librecrawl-technical-seo-audit-mcp`).
...
- **PM2 process:** `librecrawl-technical-seo-audit-mcp` (id 15).
...
- **Branding rule:** PDF footer is exactly `"Report Generated by LibreCrawl MCP — By Aditya Sharma · github.com/adityaarsharma/librecrawl-technical-seo-audit-mcp"`. **NO POSIMYTH branding** anywhere in user-visible artifacts.
